...
@Entity
@SequenceGenerator(name = "uniclass-system-id-seq", sequenceName = "UNICLASS_SYSTEM_ID_SEQ", initialValue = 200, allocationSize = 10)
@Table(name = "UNICLASS_SYSTEM")
data class UniclassSystemEntity (
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "uniclass-system-id-seq")
