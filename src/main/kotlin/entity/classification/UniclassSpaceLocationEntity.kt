...
@Entity
@SequenceGenerator(name = "uniclass-location-id-seq", sequenceName = "UNICLASS_LOCATION_ID_SEQ", initialValue = 200, allocationSize = 10)
@Table(name = "UNICLASS_SPACE_LOCATION")
data class UniclassSpaceLocationEntity (
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "uniclass-location-id-seq")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UniclassSpaceLocationEntity
