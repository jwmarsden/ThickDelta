...
@Entity
@SequenceGenerator(name = "unclass-function-id-seq", sequenceName = "UNICLASS_FUNCTION_ID_SEQ", initialValue = 200, allocationSize = 10)
@Table(name = "UNICLASS_ELEMENT_FUNCTION")
data class UniclassElementFunctionEntity (
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "unclass-function-id-seq")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UniclassElementFunctionEntity
