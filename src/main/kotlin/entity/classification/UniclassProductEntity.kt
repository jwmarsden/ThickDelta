...
@Entity
@SequenceGenerator(name = "uniclass-product-id-seq", sequenceName = "UNICLASS_PRODUCT_ID_SEQ", initialValue = 200, allocationSize = 10)
@Table(name = "UNICLASS_PRODUCT")
data class UniclassProductEntity (
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "uniclass-product-id-seq")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UniclassProductEntity
